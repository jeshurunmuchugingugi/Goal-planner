...
function App() {
  ...
  useEffect(() => {
    fetch("https://goal-planner-db.onrender.com/goals")
      .then((res) => res.json())
      .then(setGoals);
  }, []);
  ...
  function updateGoal(id, updatedFields) {
    fetch(`https://goal-planner-db.onrender.com/goals/${id}`, {
      method: "PATCH",
      headers: { "Content-Type": "application/json" },
  ...
  function deleteGoal(id) {
    fetch(`https://goal-planner-db.onrender.com/goals/${id}`, { method: "DELETE" })
